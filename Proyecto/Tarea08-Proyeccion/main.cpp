...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		if (!activated) {
			...
			ParabolicoX =  cos(MovAngleY) * currentFrame;
			
		  
				modelBullet = glm::translate(modelBullet, glm::vec3(0.0f, 0.0f, -currentFrame * velocity*1.5));
				modelBullet = glm::translate(modelBullet, glm::vec3(ParabolicoX, 0.0f, 0.0f));
				...
				modelBullet = glm::rotate(modelBullet, MovAngleY, glm::vec3(ParabolicoX, 0.0f, 0.0f));
